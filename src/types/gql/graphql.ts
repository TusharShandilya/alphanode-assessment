...
export type Mutation = {
   ...
   *
   * Equivalent to POST /{tenant}/analytics/quicksightDasbhoard
   */
  quicksightDashboardCreate?: Maybe<QuicksightDashboardCommandResponseOutput>;
  /**
   * Delete an existing dashboard entity.
   *
   * Equivalent to DELETE /{tenant}/analytics/quicksightDasbhoard/{id}
   */
  quicksightDashboardDelete?: Maybe<QuicksightDashboardCommandResponseOutput>;
  /**
   * Update an existing dashboard entity.
   *
   * Equivalent to PUT /{tenant}/analytics/quicksightDasbhoard/{id}
   */
  quicksightDashboardUpdate?: Maybe<QuicksightDashboardCommandResponseOutput>;
  /**
   * Create a new entity.
   *
  ...
  /**
   * Register a user with Quicksight.
   *
   * Equivalent to PUT /{tenant}/user/{username}/registerQuicsksight
   */
  userRegisterQuicksight?: Maybe<UserCommandResponseOutput>;
  /**
...
export type MutationQuicksightDashboardCreateArgs = {
  requestBody: QuicksightDashboardInput;
  tenant: Scalars['String']['input'];
};


export type MutationQuicksightDashboardDeleteArgs = {
  id: Scalars['String']['input'];
  tenant: Scalars['String']['input'];
};


export type MutationQuicksightDashboardUpdateArgs = {
  id: Scalars['String']['input'];
  requestBody: QuicksightDashboardInput;
  tenant: Scalars['String']['input'];
};
...
export type MutationUserRegisterQuicksightArgs = {
  tenant: Scalars['String']['input'];
  username: Scalars['String']['input'];
};
...
export type Query = {
  ...
  /**
   * Get an embed url for dashboard.
   *
   * Equivalent to GET /{tenant}/analytics/quicksightDasbhoard/{dashboardId}/embedUrl/{userName}
   */
  quicksightDashboardEmbedUrl?: Maybe<QuicksightDashboardEmbedUrlResponse>;
  /**
   * Get a list of entities.
   *
   * Equivalent to GET /{tenant}/analytics/quicksightDasbhoard
   */
  quicksightDashboardList?: Maybe<QuicksightDashboardQueryListResponse>;
  /**
   * Get an entity by ID.
   *
   * Equivalent to GET /{tenant}/analytics/quicksightDasbhoard/{id}
   */
  quicksightDashboardRead?: Maybe<QuicksightDashboardQueryReadResponse>;
  /**
...
export type QueryQuicksightDashboardEmbedUrlArgs = {
...
export type QueryQuicksightDashboardListArgs = {
...
export type QueryQuicksightDashboardReadArgs = {
  id: Scalars['String']['input'];
  tenant: Scalars['String']['input'];
};
...
export type QueryUrlListArgs = {
  appointment?: InputMaybe<Scalars['String']['input']>;
  limit?: InputMaybe<Scalars['Int']['input']>;
  order?: InputMaybe<Order24>;
  orderBy?: InputMaybe<OrderBy23>;
  page?: InputMaybe<Scalars['Int']['input']>;
...
export type QuicksightDashboardCommandResponse = {
  __typename?: 'QuicksightDashboardCommandResponse';
  resourceID: Scalars['String']['output'];
};

export type QuicksightDashboardCommandResponseOutput = Error | QuicksightDashboardCommandResponse;

export type QuicksightDashboardEmbedUrlResponse = {
  __typename?: 'QuicksightDashboardEmbedUrlResponse';
  id?: Maybe<Scalars['String']['output']>;
  resource?: Maybe<Scalars['JSON']['output']>;
};

export type QuicksightDashboardInput = {
  created?: InputMaybe<Scalars['String']['input']>;
  dashboardId: Scalars['String']['input'];
...
export type QuicksightDashboardQueryListResponse = {
  __typename?: 'QuicksightDashboardQueryListResponse';
  pages: Scalars['Int']['output'];
  resources: Array<Maybe<QuicksightDashboard>>;
};

export type QuicksightDashboardQueryReadResponse = {
  __typename?: 'QuicksightDashboardQueryReadResponse';
  id: Scalars['String']['output'];
  resource: QuicksightDashboard;
};
